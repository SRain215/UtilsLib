...
public class BarUtils {
    ...
    public static int getStatusBarHeight(Context context) {
        ...
        LogUtils.i(TAG, "getStatusBarHeight --- resourceId == " + resourceId + " , result == " + result);
        return result;
    }
    ...
    public static int getActionBarHeight(Activity activity) {
        ...
        boolean isAttribute = activity.getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true);
        if (isAttribute) {
            height = TypedValue.complexToDimensionPixelSize(tv.data, activity.getResources().getDisplayMetrics());
        }
        LogUtils.i(TAG, "getActionBarHeight --- activity == " + activity.getPackageName() + " , isAttribute == " + isAttribute + " , height == " + height);
        return height;
    }
    ...
    public static void setColor(Activity activity, int color, int statusBarAlpha) {
        LogUtils.i(TAG, "setColor --- activity == " + activity.getPackageName() + " , color == " + color + " , alpha == " + statusBarAlpha + " , SDK_INT == " + Build.VERSION.SDK_INT);
